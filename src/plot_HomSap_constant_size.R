...
## define variables
infile="../data/HomSap_constant_size.txt"
outfile="../display_items/HomSap_constant_size.pdf"
species="Homo sapiens"
pop0_name="Constant size"
method1_name="SMC++"
...
pg_custom<-ggdraw(add_sub(pg, expression(paste("Years ago")), vpadding=grid::unit(0,"lines"),y=6, x=0.5, vjust=5, size=30)) +
draw_label("Population size", x=0, y=0.55, vjust= 1.5, angle=90, size=30)
