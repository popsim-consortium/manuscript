...
## define variables
infile_pop0="../data/homo_sapiens_mask_Gutenkunst_pop0.txt"
infile_pop1="../data/homo_sapiens_mask_Gutenkunst_pop1.txt"
infile_pop2="../data/homo_sapiens_mask_Gutenkunst_pop2.txt"
outfile="../display_items/homo_sapiens_mask_Gutenkunst.pdf"
