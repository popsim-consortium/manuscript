...
% CK: perhaps we could add a bit more info here on how to contribute demographic models and a link to the tutorial when its available?
...
genetic variation. Our aim is that this catalog will grow as we continue
to refine our understanding of different species' demographic histories
and new models are published. (See the Methods for a description of the community
...
All methods for inferring demographic history have strengths and weaknesses (as recently reviewed by \citep{beichman2018review}.)
