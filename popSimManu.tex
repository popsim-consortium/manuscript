...
% ACS: We might consider deleting the next two sentences.  This feels like a lot on down-scaling, and it's a bit verbose as written.  Maybe 
% better to come back to it in the discussion if we want to say more.
...
% ACS: there was indeed a lot of redundancy here.  DRS improved it a lot, but I've tried to do a bit more
...
%ACS: seems unnecessary and redundant
