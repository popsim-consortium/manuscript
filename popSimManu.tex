...
mismatch between simulated and inferred values varies over time. In comparing inferences between the
models it is interesting to note that $N(t)$ estimates for the CHB and CEU
simulated samples are generally better across methods than estimates from the YRI simulations.
...
they do a good job of estimating the more simple simulated YRI population size history.
...
simulations of discrete, randomly mating populations that evolve neutrally and 
fit the assumptions of the methods nearly exactly --
