...
benchmark the quality of these inferences.
% or their robustness to deviations from the assumptions.
...
to allow simulation of processes that cannot be modeled under the coalescent. We validated our
implementation of the \texttt{SLiM} engine by comparing estimates of several population
genetic summary statistics for simulations generated by both engines 
