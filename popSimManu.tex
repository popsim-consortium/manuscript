...
on a catalog of species (Fig.~\ref{fig:cartoon}A), 
...
In addition to models from Table \label{tab:catalog}, 
...
Then, the QC process revealed that not only was our implementation
...
This error was in fact propagated from the \texttt{msprime} documentation.
