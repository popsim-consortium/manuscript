...
well as the \emph{Drosophila} Li & Stephan model (\cite{li2006inferring}). The human
...
migration and constant population sizes (Figure Sx).
...
on the popgensims/analysis GitHub repository (https://github.com/popgensims/analysis). The parameter
estimates from the top run from each simulation replicate are shown in Figures \ref{fig:IM_popn_human}C and Sx.
